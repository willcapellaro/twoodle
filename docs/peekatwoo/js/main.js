...
class DepthViewerApp {
    ...
    initializeElements() {
        ...
        this.currentImageIndexDisplay = document.getElementById('currentImageIndex');
        this.totalImagesDisplay = document.getElementById('totalImages');
    ...
    async loadImageSets() {
        ...
        // Initialize image counter after loading images
    ...
    toggleViewMode() {
        ...
        const icon = this.viewModeBtn.querySelector('i');
    ...
    toggleSlideshow() {
        ...
        if (this.isPlaying) {
            ...
            this.playPauseBtn.title = 'Pause Slideshow';
            this.startSlideshow();
        } else {
            icon.className = 'fas fa-play';
            this.playPauseBtn.title = 'Play Slideshow';
            this.stopSlideshow();
        }
    }
    ...
    updateImageCounter() {
        const images = this.getCurrentImages();
        if (this.currentImageIndexDisplay) {
            this.currentImageIndexDisplay.textContent = this.currentImageIndex + 1;
        }
        if (this.totalImagesDisplay) {
            this.totalImagesDisplay.textContent = images.length;
        }
    }
