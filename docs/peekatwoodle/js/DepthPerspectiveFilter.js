 ...
 */
class DepthPerspectiveFilter extends PIXI.Filter {
...
void main(void) {
    ...
    static getQualityDefines(quality) {
        ...
        return `
#define MAXSTEPS ${settings.maxSteps.toFixed(1)}
#define ENLARGE ${settings.enlarge.toFixed(1)}
#define CONFIDENCE_MAX ${settings.confidenceMax.toFixed(1)}
        `;
    }
...
window.DepthPerspectiveFilter = DepthPerspectiveFilter;